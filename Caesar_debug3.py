...
def encryptMessage(message, cipherKey, alphabet):
    ...
    for currentCharacter in uppercaseMessage:
        ...
        print(cipherKey)
        newPosition = position + cipherKey # remove the int so that decrypt key can be negative
        print(newPosition)
...
def decryptMessage(message, cipherKey, alphabet):
    ...
    return encryptMessage(message, decryptKey , alphabet) # correct viriable cipherkey to  decrypt key 
